...
// USE A LOOP TO DECREMENT OCCR TILL YOU THERES NO ONE
// THE TOTAL NUMBER OF THESE STEPS IS THE 
// ANSWER
...
int main(){
    ...
    while(t--){
        ...
        for(int i=0 ; i< n ; i++){
            // if there s no repeated numbers then break 
            if(ct == 0)
                break ; 


            // if there repeated numbers 
